$(document).ready(function () {
        ...
        updateButton.addEventListener("click", function (event) {
            ...
            if (!isValid) {
                ...
                if (confirm("Do you want to update the data?")) {
                    ajaxFormSubmit(
                        "#masterSheetFenceMarginFactorsForm", // Form ID
                        "#update-margin-factor-button", // Submit button ID
                        "/admin/mastersheet/boq/fence/update/margin_factors/", // URL for the store action
                        "post",
                        "Margin factor Detail For Fence has been Configured Succcessfully." // Success message
                    );
                } else {
                    return false;
                }
    ...
    //     $.ajax({
    //         url: '/admin/mastersheet/boq/fence/get-last-id/margin-factors', // Endpoint to get the last ID
    //         method: 'GET',
...
//         $("#masterSheetFenceMarginFactorsForm").submit();
//     });
