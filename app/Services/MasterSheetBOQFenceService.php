...
class MasterSheetBOQFenceService
{
    ...
    public function updateOrCreateFenceMaterials(Request $request)
    {
        DB::beginTransaction();
    ...
    public function updateOrCreateFenceMarginFactors(Request $request)
    {
        // Start a database transaction to ensure data integrity
    ...
    //     }
    // }
    // public function deleteFenceMaterial( $type,$id)
    // {
    //     if ($type === "materials") {
    //         try {
    ...
    //     }
    // }
    // public function deleteFencetaxes( $type,$id)
    // {
    //     if ($type === "taxes") {
    //         try {
