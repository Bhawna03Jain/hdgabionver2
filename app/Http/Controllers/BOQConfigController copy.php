...
class BOQConfigController extends Controller
{
    ...
    public function __construct(MasterSheetBOQConfigService $MasterSheetBOQConfigService, MasterSheetBOQFenceService $MasterSheetBOQFenceService, MasterSheetBOQBasketService $MasterSheetBOQBasketService, CountryService $countryService)
    {
    ...
    public function BOQFencesConfig($type = "")
    {
        ...
        $boqConfig = $this->MasterSheetBOQConfigService->getIdByType('Fence');
    ...
    // ***************************Basket*****************************************
    // public function BOQBasketsConfig($type = "")
    // {
    //     // Fetch BoQ Config based on type 'basket'
    //     $boqConfig = $this->MasterSheetBOQConfigService->getIdByType('Basket');
