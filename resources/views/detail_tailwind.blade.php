...
@section('content')
    <main class="min-h-screen">
        <section class="flex justify-around items-center flex-col sm:flex-row">
            <div
                ...
                <div class="thumbnails relative flex overflow-hidden order-2 sm:order-1z-30">
                    ...
                    <div class=" py-2 border border-gray-400 ">
                        <div id="slider" class="flex flex-row sm:flex-col items-center justify-center sm:justify-start min-h-24">
                ...
                <!-- Navigation Buttons -->
                <div class="mainImageBox flex justify-center sm:justify-end items-center order-1 sm:order-2 " id="mainImageBox">
                    {{-- <span class="close">&times;</span> --}}
                    <img class="mainImageContent w-full" id="mainImage" src="{{ asset('tmp/img/product01.png') }}">
                </div>
            </div>
            ...
            <div
                ...
                <!-- Product Title -->
                <h1 class="text-xl font-bold pb-4">PRODUCT NAME GOES HERE</h1>
                <!-- Ratings and Reviews -->
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center border rounded-full">
                        <button class="px-3 py-2" onclick="decrement()">-</button>
                        <input type="number" value="1" id="qty"
                            class="w-12 text-center border-none focus:outline-none">
                        <button class="px-3 py-2 " onclick="increment()">+</button>
                    </div>
                    <button class="bg-red text-white px-6 py-3 rounded-full hover:bg-red-light">
                        ADD TO CART
                    </button>
                </div>
                ...
                <div class="text-gray-700 text-sm pt-5">
                    <p><strong>Category:</strong> Headphones, Accessories</p>
            ...
            <div class="container mx-auto p-4">
                ...
                <div class="tab-content mt-4">
                    ...
                    <div id="description" class="hidden">
                        <p class="text-gray-700">This is the description content.</p>
                    </div>
                </div>
            </div>
