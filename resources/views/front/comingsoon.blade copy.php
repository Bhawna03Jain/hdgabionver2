    ...
    <style>
        body {
            ...
            background-image: linear-gradient(45deg, rgba(0 0, 0, 0.75),
                    rgba(0 0, 0, 0.75)), url('imagestemp/background.jpg');
            background-image: -webkit-linear-gradient(45deg, rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('images/background.jpg');
            background-image: linear-gradient(45deg, rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url('images/background.jpg');
...
<body>
    <div id="content">
        ...
        <div id="logo">
            <img src="images/gabionlogo.png" alt="">
