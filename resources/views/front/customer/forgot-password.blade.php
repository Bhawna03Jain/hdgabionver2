...
@section('content')
    ...
    <section class="mainSection">
        <div class=" mx-auto w-full md:w-2/4">
            <header class="w-full ">
                <div class="w-full">
                    <h3 class="text-center text-red text-3xl font-bold mt-10">Forgot Password</h3>
            ...
            <div class="register-container flex justify-around items-center flex-col md:flex-row">
                ...
                <div class="register-form w-full px-1" id="">
                    ...
                    <form action="javascript:;" method="POST" id="customerforgotpassword"
                        ...
                        <p class="reset-forgot-email"></p>

                        <button type="submit" class="bg-red w-full m-6 p-1 text-white rounded">Request New Password</button>
