...
<body class="font-size-normal">
    <header class="w-full">
        ...
        <!--Menu Bar-->
        <nav class="relative max-h-16 py-5 shadow-xl flex justify-between md:justify-around items-center" id="mobile_device">
            <img class="w-24 min-[450px]:w-32 sm:w-36 relative min-[450px]:absolute min-[450px]:top-[-30px] min-[450px]:left-[-10px] sm:absolute sm:top-[-30px] sm:left-[-10px] md:top-[-35px]" src="{{ asset("images/logo/HD-Gabion.png") }}" alt="">
            <div id="logobox" class="md:hidden w-full  flex items-center justify-center">
                <img class=" w-28 min-[450px]:w-36 sm:w-44" src="{{ asset("front/images/logo/logo_highres/color1/text/color1_textlogo_transparent_background.png") }}" alt="">
            </div>
            <div class="hidden md:flex w-full justify-center items-center lg:pl-10 py-5 md:pl-20">
               <ul  class="flex justify-around items-center font-semibold lg:text-base md:text-sm text-slate-700">
                <li class=" py-3 px-3 group "><a href="welcome" class="active py-1 group-hover:text-red transition-colors duration-300">Home <span class="bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class="py-1 group-hover:text-red transition-colors duration-300">About Us<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class="py-1 group-hover:text-red transition-colors duration-300">Products<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class=" py-1 group-hover:text-red transition-colors duration-300">Miscellaneous<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class=" py-1 group-hover:text-red transition-colors duration-300">Gallery<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class=" py-1 group-hover:text-red transition-colors duration-300">Blog<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
                <li  class="py-3 px-3 group "><a href="#" class=" py-1 group-hover:text-red transition-colors duration-300">Contact Us<span class=" bg-red h-0.5 w-0 group-hover:w-full block transition-all duration-300"></span></a></li>
               </ul>
            </div>
            <div class="flex justify-around items-center gap-6 ml-auto md:px-5">
                <div class="text-size-12 relative" id="parent-cart">
                    <div id="cart" class="relative  text-center flex flex-col justify-center items-center">
                        ...
                        <div class="qty absolute bg-red rounded-full size-5 right-0 top-[-10px] text-white font-bold">3</div>
                    ...
                    <ul id="cart-dropdown" class="hidden w-72 max-w-72 absolute  bg-white shadow rounded  top-19 right-[-30px]">
                            <li class="shadow">
                                    <div class="cart-list max-h-48 overflow-y-scroll  px-3 py-5">
                                        <div class="product-widget relative flex items-center justify-around">
                                            <div class="product-img max-w-12 m-3 flex justify-center items-center">
                                                <img class="w-fit object-contain" src="{{ asset("admin/images/category/2055.jpg") }}" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name font-bold mb-1"><a href="#">product name goes
                                                        here</a>
                                                </h3>
                                                <h4 class="product-price"><span class="qty">1x</span><span class="price font-bold ml-1">$980.00</span>
                                                </h4>
                                            </div>
                            ...
                            <li>
                                    <div class="mt-1 cart-btns w-full flex justify-between items-center text-center text-white text-size-14 font-bold">
                                        <a href="#" class="bg-secondary-800 p-3 w-full">View Cart</a>
                                        <a href="#" class="bg-red p-3 w-full">Checkout <i class="fa fa-arrow-circle-right pl-2"></i></a>
                                    </div>
                               </li>
    ...
    <script>
        var languageFlag = document.getElementById("languageFlag");
  ...
  <script>
    ...
    parentcart.addEventListener("click", function() {
