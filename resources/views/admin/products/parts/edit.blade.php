                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    name="attributes[no]" value="{{ old('no', $product->attributes->where('name', 'no')->first()->value ?? '')}}" >
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control" id="weight_per_unit"
                                                    name="attributes[weight_per_unit]" value="{{ old('weight_per_unit', $product->attributes->where('name', 'weight_per_unit')->first()->value ?? '')}}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    name="attributes[unit_price]" value="{{ old('unit_price', $product->attributes->where('name', 'unit_price')->first()->value ?? '')}}" required>
