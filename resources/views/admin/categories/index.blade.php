                                    ...
                                    @forelse ($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($category->category_image)
                                                    <img src="{{ asset($category->category_image) }}" alt="Category Image" style="max-width: 60px; height: auto;">
                                                @else
                                                    No Image
                                                @endif
                                            </td>
                                        ...
                                        @foreach ($category->children as $child)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($child->category_image)
                                                        ...
                                                        <img src="{{ asset($child->category_image) }}" alt="Category Image" style="max-width: 60px; height: auto;">
                                                        @else
                                                        No Image
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('categories.edit', $child->id) }}" class="text-warning"><i class="fas fa-edit"></i></a>
                                            ...
                                            @foreach ($child->children as $grandchild)
                                                <tr>
                                                    <td>{{ $grandchild->id }}</td>
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $grandchild->category_name }}</td>
                                                    <td>{{ optional($grandchild->parent)->category_name ?? 'No Parent' }}</td>
                                                    ...
                                                    <td>
                                                        @if ($grandchild->category_image)
                                                            ...
                                                            <img src="{{ asset($grandchild->category_image) }}" alt="Category Image" style="max-width: 60px; height: auto;">
                                                            @else
                                                            No Image
                                                        @endif
                                                    </td>
