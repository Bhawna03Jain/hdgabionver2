...
@section('content')
    ...
    <div class="content-wrapper" id="boqmanufacturing">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5>BOQ Manufacturing Data</h5>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">BOQ Manufacturing Data</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($manufacturing as $key => $item)
                                                    <tr data-id="{{ $item->id }}">
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-danger delete-all-Manufacturing-Button" id=""  data-id="{{ $item->id }}">    Delete</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
