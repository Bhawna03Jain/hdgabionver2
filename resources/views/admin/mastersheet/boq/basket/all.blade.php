            ...
            <div class="container-fluid">
                <div class="container mt-5">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">Margin Factors</a>
                        </li>
                    </ul><!-- Tab panes -->
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-3 active" id="tabs-1" role="tabpanel">
                            <form action="javascript:;" method="POST" id="masterSheetbasketMaterialForm">
                                @csrf
                                <input type="hidden" name="boqconfigid" value="{{ $boqConfig->id }}">
                                <div class="row">
                                    <div class="col-12 ">
                                                        ...
                                                        <tbody>
                                                            @foreach ($commonmaterials as $key => $item)
                                                                ...
                                                                <tr data-id="{{ $item->item_code }}">
                                                                    ...
                                                                    <input type="hidden"
                                                                        name="material_configs[{{ $item->id }}][{{ $item->item_code }}][item_code]"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <textarea name="material_configs[{{ $item->id }}][{{ $item->item_code }}][article_no]" class="form-control" readonly
                                                                            required>{{ $item->product->article_no ?? '' }}</textarea>
                                                                    </td>

                                                                    <!-- HS Code -->
                                                                    <td>
                                                                        <textarea name="material_configs[{{ $item->id }}][{{ $item->item_code }}][hs_code]" class="form-control" readonly>{{ $item->product->hs_code ?? '' }}</textarea>
                                                                    </td>
                                                                    <!-- Sides -->
                                                                    <td>

                                                                        <textarea name="material_configs[{{ $item->id }}][{{ $item->item_code }}][sides]" class="form-control" readonly>{{ $item->sides ?? '' }}</textarea>
                                                                    </td>
                                                                    <!-- Item Name -->
                                                                    <td>
                                                                        <textarea name="material_configs[{{ $item->id }}][{{ $item->item_code }}][item_name]" class="form-control"
                                                                            readonly required>{{ $item->product->name ?? '' }}</textarea>
                                                                    </td>
    ...
    {{-- <input type="text" step="0.01"
        ...
        value="{{ $item->price_formula ?? '' }}" readonly> --}}
                                                                ...
                                                                <tr data-id="{{ $item->id }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="number" step="0.00000001"
                                                                            name="material_configs[{{ $item->id }}][{{ $item->item_code }}][weight_per_unit]"
                                                                            class="form-control"
                                                                            value="{{ $weight_per_unit ?? '' }}" readonly>
                                                                    </td>
                                                ...
                                                <table id="productTable" class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($allmaterials as $material)
                                                            <tr>
                                                                <td data-label="Select"><input type="radio"
                                                                        name="productSelect" value="{{ $material->id }}">
                                                                </td>
                                                                <td data-label="id">{{ $material->id }}</td>
                                                                <td data-label="article_no">{{ $material->article_no }}
                                                                </td>
                        ...
                        <div class="tab-pane p-3" id="tabs-2" role="tabpanel">
                            <form action="javascript:;" method="POST" id="masterSheetAllManufacturingForm">
                                @csrf
                                <input type="hidden" name="boqconfigid" value="{{ $boqConfig->id }}">
                                <div class="row">
                                    <div class="col-12 ">
                                        <p class="text-warning">* Fields whose values are derived from other field value
                                            are not
                                            permitted to edit.</p>
                                    </div>
                                    <div class="col-12">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($manufacturing as $key => $item)
                                                                <tr data-id="{{ $item->id }}">
                                                                    <td>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text"
                                                                                ...
                                                                                id="manufacturing_code_{{ $item->id }}"
                                                                                required readonly>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                class="form-control manufacturing-input editable-field"
                                                                    ...
                                                                    {{-- <td>
                                                                        <button type="button" class="btn btn-danger " id="delete-all-Manufacturing-Button"  data-id="{{ $item->id }}">    Delete</button>
                                                                    </td> --}}
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-primary" id="addManufacturingRowButton">Add
                                            Row</button>
                                        <fieldset>
                        ...
                        <div class="tab-pane p-3" id="tabs-3" role="tabpanel">
                            <form action="javascript:;" method="POST" id="masterSheetAlltaxesForm">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-primary" id="addTaxesRowButton">Add
                                            Row</button>
                                        <fieldset>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ $item->margin_factor ? $item->margin_factor : '' }}"
                                                                            required readonly>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="number"
                                                                            ...
                                                                            class="form-control editable-field margin-factor-input"
                                                                            value="{{ $item->discount_per ? $item->discount_per : '' }}"
                                                                            required readonly>
                                                                    </div>
                                                                </td>
                                                            </tr>
...
@section('jscript')
    ...
    <!-- DataTables & Plugins -->
    <script src="{{ asset('admin/js/mastersheet-boq-all-manufacturing.js') }}"></script>
